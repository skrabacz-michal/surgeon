...
import demo.surgeon.asideas.de.surgeon.R;
...
public class InteractiveLineGraphView extends View
{
     ...
     * @param outStops The destination {@link com.example.android.interactivechart.InteractiveLineGraphView.AxisStops} object to populate.
     */
     ...
     * canvas. This method does not clip its drawing, so users should call {@link android.graphics.Canvas#clipRect
